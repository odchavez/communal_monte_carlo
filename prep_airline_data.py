...
class prep_data:
    def __init__(self, params, path, f_rank):
        ...
        if self.model== "probit_sin_wave":
            ...
            ['Y', 'time_value', 'X_matrix', 'N', 'b', 'B', 'Tau_inv_std', 'model', 'shards', 'all_shard_unique_time_values', 'predictors', 'p']
...
#
    ...
    def format_for_scatter(self, epoch, f_rank):
        ...
        #print(self.output['epoch_data']["epoch"+str(epoch)]["shard_"+str(f_rank)].keys())
        #return( self.output['epoch_data']["epoch"+str(epoch)]["shard_"+str(f_rank)])
